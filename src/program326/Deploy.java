...
//		
//		int coolCount = 0;
//		while (timer.getTimeDelay() < 5000) {
//			coolCount++;
//			
//			int fit1 = history.get(Deploy.curCode);
//			
//			//随机一个邻域
//			int from = curSources.get(random.nextInt(curSources.size()));
//			List<GraphO.Edge> links = graphO.edges.get(from);
//			int to = from;
//			while (curSources.contains(to)) {
//				to = links.get(random.nextInt(links.size())).end;
//			}
//			curSources.remove(new Integer(from));
//			curSources.add(to);
...
//			
//
//			logger.println(curSources + " cost: " + curCost + " fit: " + fit2);
//
//			double leapProbability = Math.exp((fit2 - fit1) / temperature);
//			
//			logger.println(leapProbability);
//			logger.flush();
//			
//			if (fit2 > fit1) {
//				Deploy.curCode = curCode;
//			} else if (Math.random() < leapProbability) {
//				Deploy.curCode = curCode;
//			}
//			
...
//		}
//		
//		LogUtil.printLog("----------coolCount " + coolCount);
...
//				logger.println("historyMinFitess " + historyMinFitness);
				...
				if (maxFitness > minFitness) {
					double slope = (5.0 * maxFitness - minFitness / panish) / (maxFitness - minFitness);
					for (int i = 0; i < numOfPopulation; i++) {
			...
			//输出调整过后的适应度
//			if (logger != null) {
//				logger.println("generation " + generation + " modifiedFitness:");
//				int maxFitness = history.get(minCode);
//				logger.println("maxFitness " + maxFitness);
//				logger.println("minFitness " + minFitness);
//				logger.println("slope " + 10.0 * maxFitness / (maxFitness - minFitness));
//				for (int j = 0; j < numOfPopulation; j++) {
//					logger.print(fitness[j] + " ");
//				}
//				logger.println();
//			}
...
//			double mutateProbability = minCount < enhanceLine ? 0.1 : 0.2;
			double mutateProbability = (0.2 / numOfPopulation) * minCount + 0.2;

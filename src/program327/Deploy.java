...
{	
	...
	private static int fitnessRatio;
	/**
     * 你需要完成的入口
     * <功能详细描述>
...
//    	List<Integer> curSources = new ArrayList<>(Arrays.asList(new Integer[]{36, 55, 106, 165, 270, 305, 391, 496, 615, 655}));
//    	chooseNearly(curSources);
...
//			int historyMaxFitness = history.get(minCode);
//			for (int i = 0; i < fitness.length; i++) {
//				if (fitness[i] != historyMaxFitness) {
//					fitness[i] /= panish;
//				}
//			}
...
//				logger.println("historyMinFitess " + historyMinFitness);
			...
			//输出种群信息
//			if (generation < 3000) {
//				logger.println("max: " + maxFitness + " min: " + minFitness + " slope: " + slope + " panish: " + panish);
...
//			double mutateProbability = minCount > enhanceLine ? 0.8 :
//				(0.2 / numOfPopulation) * minCount + 0.15;
